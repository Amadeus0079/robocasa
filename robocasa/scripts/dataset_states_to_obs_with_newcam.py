...
def extract_trajectory(
    ...
    d_range = sample_sub_range(D_RANGE, d_window)
    a_range = sample_sub_range(A_RANGE, a_window)
    e_range = sample_sub_range(E_RANGE, e_window)
    ...
    for idx, t in enumerate(index):
        ...
        sampled_states, sampled_poses = sample_cameras(lookat=eef_pos, d_range=d_range, a_range=a_range, e_range=e_range, num_cameras=1)
        extrinsic_matrix_newcam = sampled_poses[0]
